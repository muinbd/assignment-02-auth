...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['remember-me'])) {
            ...
            <form method="POST" class="space-y-6 animate-fadeIn">
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a
                            href="#"
                            class="text-sm font-medium text-indigo-600 hover:text-indigo-500 transition-colors">Forgot password?</a>
                    </div>
                    <div class="relative">
                        <div
                            class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
