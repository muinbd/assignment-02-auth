        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-gray-600">Welcome back, <?= htmlspecialchars(Auth::userName()) ?>!</p>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex flex-col md:flex-row md:items-center">
                            ...
                            <div class="mt-4 md:mt-0 md:ml-6 flex-1">
                                <h3 class="text-xl font-bold text-gray-800"><?= htmlspecialchars(Auth::userName()) ?></h3>
                            </div>
                        </div>
                        ...
                        <div class="mt-8">
                            <div class="p-4 border rounded-lg">
                                ...
                                <p class="font-medium"><?= htmlspecialchars($_SESSION['user_email'] ?? 'N/A') ?></p>
                            </div>
                        </div>
                    </div>
                </div>
