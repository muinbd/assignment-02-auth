...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $validator->validateRequired('confirm_password', $confirm);
    ...
    if ($password !== '') {
        $validator->validateMinLength('password', $password, 6);
    }
        ...
        <div
            ...
            <?php if (!empty($errors)): ?>
                <div class="mb-4 bg-red-50 border border-red-200 rounded-lg">
                    <ul class="text-sm text-red-600 space-y-1 p-2">
            ...
            <form method="POST" class="space-y-6 animate-fadeIn">
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                type="text" name="name" value="<?= htmlspecialchars($old['name'] ?? '') ?>"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            type="email" name="email" value="<?= htmlspecialchars($old['email'] ?? '') ?>"
                            class="w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent input-focus transition-all duration-300"
